// src/lib.rs
/*
 * Core library for ResponseBuilder
 */
...
#[derive(Debug)]
pub struct ResponseBuilderProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ResponseBuilderProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ResponseBuilder processing");
    
    let mut processor = ResponseBuilderProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ResponseBuilderProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ResponseBuilderProcessor::new(false);
